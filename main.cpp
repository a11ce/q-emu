...
int main(void) {
  ...
  auto circuit1 = parseCircuitDiagram("|0>-H!-.\n"
                                      "|0>--!-X\n");
  circuit1.print();
  printStateVector(circuit1.run(makeStateVector(2)));
  ...
  /// Grovers
  auto SV100 = makeTargetStateVector("100");
  testStateVectorsEqual(SV100, {Complex(1, 0), Complex(0, 0), Complex(0, 0)},
